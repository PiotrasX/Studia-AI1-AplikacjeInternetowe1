...
@include('shared.head', ['pageTitle' => 'Wyciki górskie'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Jest wyżynno-górzystym stanem, którego średnia wysokość nad poziomem morza
                            przekracza 2000 m. Najwyższy szczyt Kolorado, Mount Elbert, wznosi się na 4399 m n.p.m. </p>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Pasmo górskie w Ameryce Północnej w stanie Alaska. Jest to najwyższa część
                            łańcucha Kordylierów z najwyższym szczytem kontynentu - Denali (McKinley) (6194 m n.p.m.).
                        </p>
                        <a href="#" class="btn btn-primary">Więcej szczegółów...</a>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Najwyższy szczyt Ziemi (8848 m n.p.m., podaje się też wysokość 8844 lub
                            8850), ośmiotysięcznik położony w Himalajach Wysokich, na granicy Nepalu i Tybetu.</p>
                        <a href="#" class="btn btn-primary">Więcej szczegółów...</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Najwyższy łańcuch górski Europy, ciągnący się łukiem od wybrzeża Morza
                            Śródziemnego w okolicy Savony po dolinę Dunaju w okolicach Wiednia.</p>
                        <a href="#" class="btn btn-primary">Więcej szczegółów...</a>
                    </div>
                </div>
            </div>
                ...
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" min="0" placeholder="20000" step="any"
