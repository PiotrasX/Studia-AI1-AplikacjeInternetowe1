                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('trips.show', ['id' => $trip->id]) }}" class="btn btn-primary">Więcej
                                szczegółów...</a>
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    @forelse ($trips as $trip)
                        <tr>
                            <th scope="row">
                                <a href="{{ route('trips.show', $trip->id) }}">{{ $trip->id }}</a>
                            </th>
                            <td>{{ $trip->name }}</td>
                            <td>{{ $trip->continent }}</td>
                            <td><a
                                    href="{{ route('countries.show', $trip->country_id) }}">{{ $trip->country->name }}</a>
                            </td>
