...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                <form method="POST" action="{{ route('countries.update', $country->id) }}" class="needs-validation"
                    novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="code" name="code" type="text"
                            class="form-control @if ($errors->first('code')) is-invalid @endif"
                            value="{{ $country->code }}">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="currency" name="currency" type="text"
                            class="form-control @if ($errors->first('currency')) is-invalid @endif"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="input-group mb-2">
                            <input id="area" type="number" name="area" min="0" placeholder="0"
                                step="any" class="form-control @if ($errors->first('area')) is-invalid @endif"
                                value="{{ $country->area }}">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="language" name="language" type="text"
                            class="form-control @if ($errors->first('language')) is-invalid @endif"
