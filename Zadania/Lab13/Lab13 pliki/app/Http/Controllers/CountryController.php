...
class CountryController extends Controller
{
    ...
    {
        if (Gate::denies('is-admin')) return response()->json(['message' => 'Brak odpowiednich uprawnień!'], 403); // 403
        if ($country->trips()->exists()) abort(400, "Nie można usunąć kraju, w którym odbywają się wycieczki!"); // 400
        return $country->delete() ? response()->json(['message' => 'Kraj usunięty!'], 204) : abort(404, "Błąd przy usuwaniu kraju!"); // 204, 404
    }
}
