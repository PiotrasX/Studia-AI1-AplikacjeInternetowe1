...
@include('shared.head', ['pageTitle' => 'Ustawienia'])
    ...
    <main class="content container my-5">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                <form method="POST" action="{{ route('candidate.settingsAuthenticate') }}" class="needs-validation"
                    ...
                    <label for="change_password_checkbox" class="form-label">
                        <input type="checkbox" id="change_password_checkbox" name="change_password_checkbox"
                            value="1" {{ old('change_password_checkbox') ? 'checked' : '' }}>
                        Zmień hasło
                    </label>
                    <div class="form-group mb-3 card card-bg-color" id="watchword-div" style="display: none;">
                    ...
                    <div class="form-group mb-3 card card-bg-color" id="watchword-confirmation-div"
                        style="display: none;">
                    ...
                    <div class="text-center mt-4 mb-2 pt-2">
                        <button class="btn btn-danger color-after" type="submit">Popraw dane</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const watchwordDiv = document.getElementById('watchword-div');
        const watchwordConfirmationDiv = document.getElementById('watchword-confirmation-div');

        function setDivVisibility() {
            if (checkbox.checked) {
                watchwordDiv.style.display = 'block';
                watchwordConfirmationDiv.style.display = 'block';
            } else {
                watchwordDiv.style.display = 'none';
                watchwordConfirmationDiv.style.display = 'none';
            }
        }
